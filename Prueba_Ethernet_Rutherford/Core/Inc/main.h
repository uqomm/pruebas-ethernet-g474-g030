...
#define SCLK_W5500_Pin GPIO_PIN_5
#define SCLK_W5500_GPIO_Port GPIOA
#define MISO_W5500_Pin GPIO_PIN_6
#define MISO_W5500_GPIO_Port GPIOA
#define MOSI_W5500_Pin GPIO_PIN_7
#define MOSI_W5500_GPIO_Port GPIOA
#define INTN_W5500_Pin GPIO_PIN_4
#define INTN_W5500_GPIO_Port GPIOC
#define NRST_W5500_Pin GPIO_PIN_5
#define NRST_W5500_GPIO_Port GPIOC
